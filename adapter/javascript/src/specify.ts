...
export function specify(context: $Context, name: string, value: $Value): $Reference {
  ...
  if (value instanceof Object && !(value instanceof Array)) {
    ...
    define && specify_reserved(context, set_define, reference, define)
    extend && specify_reserved(context, set_extend, reference, extend)
...
function specify_reserved(context: $Context, apply_fn: typeof set_define | typeof set_extend, ref: $Reference, value: $Value) {
  if (value instanceof Object && !(value instanceof Array)) {
